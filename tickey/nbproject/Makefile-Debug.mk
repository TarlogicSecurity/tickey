...
${OBJECTDIR}/keyctl.o: keyctl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/keyctl.o keyctl.c

${OBJECTDIR}/keyrings.o: keyrings.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/keyrings.o keyrings.c

${OBJECTDIR}/krb_conf.o: krb_conf.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/krb_conf.o krb_conf.c
...
${OBJECTDIR}/proc_info/proc_info.o: proc_info/proc_info.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/proc_info/proc_info.o proc_info/proc_info.c

${OBJECTDIR}/string_utils.o: string_utils.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/string_utils.o string_utils.c

${OBJECTDIR}/tickets.o: tickets.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tickets.o tickets.c

${OBJECTDIR}/traceter/p_trace.o: traceter/p_trace.c 
	${MKDIR} -p ${OBJECTDIR}/traceter
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/traceter/p_trace.o traceter/p_trace.c

${OBJECTDIR}/traceter/traceter.o: traceter/traceter.c 
	${MKDIR} -p ${OBJECTDIR}/traceter
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/traceter/traceter.o traceter/traceter.c

${OBJECTDIR}/traceter/utils.o: traceter/utils.c 
	${MKDIR} -p ${OBJECTDIR}/traceter
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/traceter/utils.o traceter/utils.c

${OBJECTDIR}/user_session.o: user_session.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user_session.o user_session.c
